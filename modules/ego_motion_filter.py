...
class EgoMotionFilter(nn.Module):
    ...
    def load_pretrained(self,savepath):
        checkpoint = torch.load(savepath)
        print(checkpoint.keys())
        self.motion_estimator.load_state_dict(checkpoint['estimator_state_dict'])
        self.camera_head.load_state_dict(checkpoint['cam_head_state_dict'])
